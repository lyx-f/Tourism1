...
$query = "SELECT id, name, latitude, longitude FROM locations WHERE status = 'active'";  // Modify as needed
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td>
                    ...
                    <form action='process-locations.php' method='POST' style='display:inline-block;'>
