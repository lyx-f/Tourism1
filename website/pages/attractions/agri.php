...
$query = "SELECT id, name, image_url, status FROM businesses WHERE sub_category = 'agri-tourism'";
...
<body>
    <div class="wrapper">
        ...
        <div class=" container">
            <h1 class="page-title">Available Agri-tourism</h1>
