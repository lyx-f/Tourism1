...
$query = "SELECT id, name, image_url, status FROM businesses WHERE category = 'Hotels'";
            ...
            <?php foreach ($hotels as $hotel): ?>
                    <div class="card" onclick="window.location.href='des_info.php?id=<?= $hotel['id']; ?>'">
                        <div class="card-header">
                          <img src="../../assets/img/<?php echo htmlspecialchars($hotel['image_url']); ?>" alt="<?php echo htmlspecialchars($hotel['name']); ?>">
