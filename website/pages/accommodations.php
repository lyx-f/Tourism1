...
<body>
    ...
    <div class="grid-container">
        <a href="./accommodations/hotels.php" class="card">
        ...
        <a href="./accommodations/inns.php" class="card">
                ...
                <?php foreach ($accommodations as $accommodation): ?>
                    <div class="card" onclick="window.location.href='des_info.php?id=<?= $accommodation['id']; ?>'">
                        <div class="card-header">
                            <img src="../../assets/img/<?php echo htmlspecialchars($accommodation['image_url']); ?>"
