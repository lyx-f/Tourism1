...
<body>
    <div class="booking-form">
            ...
            <?php elseif ($category === 'attractions'): ?>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" id="adult_quantity" name="adult_quantity" min="0" value="0" required onchange="calculateBill()">
                    </div>
                    <div class="form-group">
                        <label for="senior_quantity">Senior Tickets ($40 each):</label>
                        <input type="number" id="senior_quantity" name="senior_quantity" min="0" value="0" required onchange="calculateBill()">
                    </div>
                    <div class="form-group">
                        <label for="child_quantity">Child Tickets ($30 each):</label>
                        <input type="number" id="child_quantity" name="child_quantity" min="0" value="0" required onchange="calculateBill()">
                    </div>
                </div>
        ...
        <div class="form-group">
            ...
            <select id="accommodation_type" name="accommodation_type" required onchange="toggleAccommodationDetails()">
        ...
        <!-- Cottage Options -->
        <div id="cottage_options" class="accommodation-details" style="display: none;">
            <div class="form-group">
    <label for="cottage_type">Select Cottage Type:</label>
    <select id="cottage_type" name="cottage_type" required onchange="calculateBill()">
        ...
        <!-- Room Options -->
        <div id="room_options" class="accommodation-details" style="display: none;">
            <div class="form-group">
                <label for="room_type">Room Type:</label>
    ...
    <div class="form-group">
        ...
        <input type="datetime-local" id="reservation_datetime" name="reservation_datetime" required>
                ...
                <div class="form-group">
                    ...
                    <textarea id="special_requests" name="special_requests" placeholder="Enter special requests here"></textarea>
                </div>
...
<script>
    function toggleAccommodationDetails() {
        ...
        document.getElementById('cottage_options').style.display = (accommodationType === 'cottage') ? 'block' : 'none';
        document.getElementById('room_options').style.display = (accommodationType === 'room') ? 'block' : 'none';
    }
